...
import type { LauncherView, WindowData } from '../types/windows';
...
const WindowManager = ({ windowSize, initialWindows = [], focusMode: initialFocusMode = false, blogFullscreen = false }: WindowManagerProps) => {
