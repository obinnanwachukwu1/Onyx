...
import { BlogPostSummary } from '../utils/posts';
            ...
            <article key={post.slug}>
              {onPostClick ? (
                ...
                >
                  ...
                  <h2 className="mt-1 mb-2 text-xl font-semibold text-zinc-900 dark:text-zinc-100 transition-colors group-hover:text-blue-600 dark:group-hover:text-blue-400">
                    {post.title}
                  </h2>
                  {post.subtitle && (
